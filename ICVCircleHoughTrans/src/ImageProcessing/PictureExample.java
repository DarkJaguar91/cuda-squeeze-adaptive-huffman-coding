 ...
 */
public final class PictureExample implements ActionListener {
   ...
   /**
     ...
     */
    public PictureExample(int w, int h) {
        width = w;
        height = h;
   ...
   /**
     * Copy constructor.
     */
    public PictureExample(PictureExample pic) {
        width = pic.width();
        height = pic.height();
   ...
   /**
     ...
     */
    public PictureExample(String filename) {
   ...
   /**
     ...
     */
    public PictureExample(File file) {
   ...
   /**
    ...
    public boolean equals(Object obj) {
        ...
        PictureExample that = (PictureExample) obj;
   ...
   /**
    ...
    public static void main(String[] args) {
        PictureExample pic = new PictureExample(args[0]);
